...
proptest! {
    ...
    fn prop_agent_key_fingerprint_stored_and_retrievable(
        ...
        let ssh_config = SshConfig {
            ...
            startup_command: None, jump_host_id: None, sftp_enabled: false, port_forwards: Vec::new(), waypipe: false, ssh_agent_socket: None, keep_alive_interval: None, keep_alive_count_max: None,
        };
